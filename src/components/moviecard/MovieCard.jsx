          ...
          <div className='movie-card-bottom'>
              ...
              <div className='icon-line'>
                  {isMovieInShortlist( movie.id ) ?
                    <img onClick={() => handleRemoveFromShortlist( movie, setMovies )} src={shortlistFill}
                      alt='shortlist icon fill'/>
                    :
                    <img onClick={() => handleAddToShortlist( movie, setMovies )} src={shortlistNoFill}
                      alt='shortlist icon no fill'/>
                  }
                  {isMovieInFavorites( movie.id ) ?
                    <img onClick={() => handleRemoveFromFavorites( movie, setMovies )} src={favoritesFill}
                      alt='favorites icon fill'/>
                    :
                    <img onClick={() => handleAddToFavorites( movie, setMovies )} src={favoritesNoFill}
