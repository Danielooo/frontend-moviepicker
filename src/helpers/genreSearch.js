...
// ); setGenreChoiceId( genre.id );  } catch ( e ) { toggleLoading( false ) toggleErrorGenre( true ) console.error( e )
// } } }
//
...
//             `https://api.themoviedb.org/3/discover/movie?with_genres=${genreChoiceId}&sort_by=vote_average.desc&vote_average.gte=7.0&vote_count.gte=200&page=1?include_adult=false`,
// options ); setMovies( response.data.results ); } catch ( e ) { toggleLoading( false ); toggleErrorGenre( true );
// console.error( e ); } }